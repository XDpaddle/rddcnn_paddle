...
parser.add_argument(
    '-opt', type=str, default='config/test/test_rddcnn.yml', required=True, help='Path to option YAML file.')
parser.add_argument('--result_dir', default='./results/Gaussian_Color_Denoising/', type=str,
                    help='Directory for results')
parser.add_argument('--weights', default='trans_weights/trans_rddcnn_25.pdparams', type=str, help='Path to weights')
